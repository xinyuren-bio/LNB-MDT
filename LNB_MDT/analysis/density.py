...
from .parameter_utils import parse_residues_simple, parse_gas_group_simple 
...
def parse_args():
    ...
    parser.add_argument(
        ...
        help="Enable verbose output (default: True in CLI mode)."
    )
    parser.add_argument(
        "--no-verbose",
        action="store_false",
...
def main():
    ...
    if args.test:
        ...
        args.output_csv = os.path.join(test_dir, 'density.csv')
        
        # Set default parameters for test
        args.residues = "DPPC:PO4,CHOL:ROH"
        args.gas_group = "O2:O2"
        ...
        print(f"Gas Group: {args.gas_group}")
        print("=" * 40)
    ...
    density_analysis._verbose = args.verbose
