...
# 延迟导入 MainWindow 以避免循环依赖
def _get_MainWindow():
    from LNB_MDT.main import MainWindow
    return MainWindow

# 使用 TYPE_CHECKING 来处理类型提示，避免运行时导入
...
class UIFunctions:
    # 在运行时获取 MainWindow 作为基类
    def __init_subclass__(cls):
        MainWindow = _get_MainWindow()
        cls.__bases__ = (MainWindow,) + cls.__bases__
    # MAXIMIZE/RESTORE
    # ///////////////////////////////////////////////////////////////
