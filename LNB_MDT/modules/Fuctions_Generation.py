...
from LNB_MDT.preparation.lipidsInfo_martini3 import *
from .Tools import *
global window
...
def get_resource_path(relative_path):
    ...
    try:
        ...
        # 获取 LNB_MDT 包的路径
        import LNB_MDT
        # LNB_MDT.__file__ 指向 LNB_MDT/__init__.py
        # 所以 LNB_MDT 包的根目录是 os.path.dirname(LNB_MDT.__file__)
...
class BtnGeneClick:
    # 使用 get_resource_path 获取正确的脚本路径
    # 相对路径从 LNB_MDT 包根目录开始
    LNB_PATH: str = get_resource_path('preparation/lnb_gener_martini3.py')
