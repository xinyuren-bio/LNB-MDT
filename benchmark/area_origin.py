...
if __name__ == "__main__":
    ...
    csv_file_serial = "cases/csv/anisotropy_origin.csv"
    u = mda.Universe(gro_file, xtc_file)
    # --- Analysis Parameters ---
    residue_group = {'DPPC':['PO4'], 'DUPC':['PO4'], 'CHOL':['ROH']}
    k_value = 20
    angle = 180
    analysis_serial = Area(u, residue_group, k=k_value, max_normal_angle_deg=angle, file_path=csv_file_serial)
    analysis_serial.run(verbose=False)